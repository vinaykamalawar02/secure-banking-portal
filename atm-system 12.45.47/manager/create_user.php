            ...
            if ($stmt->fetch()) {
                ...
                if ($stmt->fetch()) {
                    ...
                    try {
                        ...
                        // Create user with manager_id set to current manager
                        $stmt = $conn->prepare("
                            INSERT INTO users (name, username, password, email, phone, account_number, balance, manager_id, status) 
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, 'active')
                        ");
                        $stmt->execute([
                            $name, $username, $hashed_password, $email, $phone, 
                            $account_number, $initial_balance, $_SESSION['user_id']
                        ]);
                        ...
                        // Log activity
                        log_activity($_SESSION['user_id'], 'manager', 'Created new user: ' . $username);
...
<body class="bg-gray-50">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">Add a new customer to your branch</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="space-y-3 text-sm text-gray-600">
                        ...
                        <div class="flex items-start">
                            <i class="fas fa-check text-green-500 mt-1 mr-2"></i>
                            <span>User will be assigned to your branch</span>
                        </div>
                        <div class="flex items-start">
                            <i class="fas fa-check text-green-500 mt-1 mr-2"></i>
                ...
                <div class="bg-white rounded-lg shadow">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h3 class="text-lg font-medium text-gray-900">Your Recent Users</h3>
                    </div>
                    <div class="p-6">
                        <?php
                        $stmt = $conn->prepare("
